...
function peg$parse(input, options) {
  ...
  var peg$e14 = peg$literalExpectation("SET", true);
  var peg$e15 = peg$literalExpectation("REMOVE", true);
  var peg$e16 = peg$literalExpectation("ADD", true);
  var peg$e17 = peg$literalExpectation("DELETE", true);
  var peg$e18 = peg$otherExpectation("whitespace");
  var peg$e19 = peg$classExpectation([" ", "\t", "\r", "\n"], false, false);

  var peg$f0 = function(sections) {
      return checkErrors() || {sections: sections, paths: paths, nestedPaths: nestedPaths}
    };
  var peg$f1 = function(head, sec) { return sec };
  var peg$f2 = function(head, tail) {
      return [].concat.apply(head, tail)
    };
  var peg$f3 = function(args) {
      checkSection('SET')
      return args
    };
  ...
  var peg$f7 = function(head, expr) { return expr };
  var peg$f8 = function(head, tail) {
      return [head].concat(tail)
    };
  var peg$f9 = function(head, expr) { return expr };
  var peg$f10 = function(head, tail) {
      return [head].concat(tail)
    };
  var peg$f11 = function(head, expr) { return expr };
  var peg$f12 = function(head, tail) {
      return [head].concat(tail)
    };
  var peg$f13 = function(head, expr) { return expr };
  var peg$f14 = function(head, tail) {
      return [head].concat(tail)
    };
  var peg$f15 = function(path, val) {
      checkPath(path)
  ...
  var peg$f28 = function(head, ix) {
        return +(ix.join(''))
      };
  var peg$f29 = function(head, prop) {
        return prop
      };
